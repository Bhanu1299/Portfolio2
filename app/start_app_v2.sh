...
main() {
    ...
    if [ "$LOCAL_MODE" = true ]; then
        /Users/bhanuteja/Library/Python/3.9/bin/uv venv
        source .venv/bin/activate
        /Users/bhanuteja/Library/Python/3.9/bin/uv pip install  -r requirements.txt -i http://mirrors.aliyun.com/pypi/simple --trusted-host mirrors.aliyun.com || true
        /Users/bhanuteja/Library/Python/3.9/bin/uv pip install  -r requirements.default -i http://mirrors.aliyun.com/pypi/simple --trusted-host mirrors.aliyun.com
    else
        /Users/bhanuteja/Library/Python/3.9/bin/uv pip install  -r requirements.txt || true
        /Users/bhanuteja/Library/Python/3.9/bin/uv pip install  -r requirements.default
    fi
